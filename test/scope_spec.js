...
describe("Scope", function() {
    it("can be construted and used as an object", function() {
        var scope = new Scope();
        scope.aProperty = 1;
    ...
    describe("digest", function() {
        ...
        it("calls the listener function of a watch on first $digest", function() {
            var watchFn = function() { return 'wait'; },
        ...
        it("passes the second $eval argument staright through", function() {
            scope.aValue = 42;
    ...
    describe('$watchGroup', function() {
        ...
        it('does not call the zero-watch listener when deregister first', function() {
            var counter = 0;
    ...
    describe('inheritance', function() {
        ...
        it('does not shadow members of parent scope\'s attribute', function() {
            var parent = new Scope(),
                child = parent.$new();
        ...
        it('cannot watch parent attributes when isolated', function() {
            ...
            child.$watch(
                function(scope) { return scope.aValue; },
                function(newValue, oldValue, scope) {
                    scope.aValuesWas = newValue;
                }
            );
    
            child.$digest();
            expect(child.aValuesWas).toBeUndefined();
        });
        ...
        it('digest its isolated children', function() {
            ...
            parent.$digest();
            expect(child.aValuesWas).toBe('abc');
        });
    ...
    describe('$watchCollection', function() {
        ...
        it('notices an item aded to an array', function() {
            scope.arr = [1, 2, 3];
            scope.counter = 0;
        ...
        it('notice items reordered in an array', function() {
            scope.arr = [2, 1, 3];
            scope.counter = 0;
        ...
        it('noticed when an attribute is changed in an object', function() {
            scope.counter = 0;
            scope.obj = {a: 1};
    ...
    describe('Events', function() {
        ...
        _.forEach(['$emit', '$broadcast'], function(method) {
            ...
            it('does not skip the next listener when removed on ' + method, function() {
                var deregister, listener, nextListener;
                
                listener = function() {
                    deregister();
                };
                nextListener = jasmine.createSpy();
        ...
        it('propagates up the scope hierarchy on $emit', function() {
            var parentListener = jasmine.createSpy(),
                scopeListener = jasmine.createSpy();
        ...
        it('attaches currentScope on $emit', function() {
            var currentScopeOnScope, currentScopeOnParent, scopeListener, parentListener;
            
            scopeListener = function(event) {
                currentScopeOnScope = event.currentScope;
            };
            
            parentListener = function(event) {
        ...
        it('attaches currentScope on $broadcast', function() {
            var currentScopeOnScope, currentScopeOnChild, scopeListener, childListener;
            
            scopeListener = function(event) {
                currentScopeOnScope = event.currentScope;
            };
            
            childListener = function(event) {
        ...
        it('sets currentScope to null after propagation on $emit', function() {
            var event, scopeListener;
            
            scopeListener = function(evt) {
                event = evt;
            };
        ...
        it('does not propagate to parents when stopped', function() {
            var parentListener, scopeListener = function(event) {
